...
export interface ISolicitacaoRelatorioRepository {
  ...
  updateStatus(id: string, status: StatusSolicitacaoRelatorio, observacaoGestor?: string | null, empresaId?: string): Promise<{ data: SolicitacaoRelatorio | null; error: unknown }>
